...
//============================================================
	...
	/**
	 * Permet de g�n�raliser la cr�ation des robots et ainsi en avoir 2 ou plus sur la grille
	 * @param Robot
	 * @param ListeRobot 
	 * @return La liste des robots compl�te 
	 */
	...
	/**
	 * M�thode qui active le bouclier du robot
	 */
	...
	/**
	 * M�thode pour d�sactiver le bouclier du robot
	 */
	...
	/**
	 * M�thode pour retirer un point de Stamina
	 */
	...
	/**
	 * M�thode pour ajouter un point de Stamina
	 */
	...
	/**
	 * M�thode qui v�rifie si  le robot est bien dans la grille
	 * @param Hauteur
	 * @param Longueur
	 */
	...
	/**
	 * Mise � jour du robot (Perte de stamina et verification de position). Effectu� � la fin de chaque tour
	 * @param Grille
	 */
